...
class ReportingTest(unittest.TestCase):
    ...
    def test_render_markdown_escapes_table_cells(self) -> None:
        ...
        self.assertIn("mock\\|model", markdown)
        self.assertIn("Best quality \\| candidate", markdown)
        self.assertIn("quality\\|gate", markdown)
        self.assertIn(">=\\|minimum", markdown)
        self.assertIn("refund flow\\|v1", markdown)
        self.assertIn("Repeated \\| prompt ids.", markdown)
    ...
    def test_render_rag_markdown_escapes_table_cells(self) -> None:
        report = RagReport(
            run_name="rag",
            description="",
            results=[
        ...
        self.assertIn("| mock\\|model | case 1\\|rag |", markdown)
    ...
    def test_render_tracecard_markdown_escapes_table_cells(self) -> None:
        report = TraceCardReport(
            run_name="trace",
            description="",
            tracecards=[
        ...
        self.assertIn("| task 1\\|trace | success\\|with note |", markdown)
